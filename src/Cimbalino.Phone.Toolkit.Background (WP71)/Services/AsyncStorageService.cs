// ****************************************************************************
// <copyright file="AsyncStorageService.cs" company="Pedro Lamas">
...
{
    /// <summary>
    /// Represents an implementation of the <see cref="IAsyncStorageService"/>.
    /// </summary>
    public class AsyncStorageService : IAsyncStorageService
    {
        ...
        {
            return Task.Factory.StartNew(() => Storage.CopyFile(sourceFileName, destinationFileName));
        }
        ...
        {
            return Task.Factory.StartNew(() => Storage.CopyFile(sourceFileName, destinationFileName, overwrite));
        }
        ...
        {
            return Task.Factory.StartNew(() => (Stream)Storage.CreateFile(path));
        }
        ...
        {
            return Task.Factory.StartNew(() => Storage.DeleteDirectory(dir));
        }
        ...
        {
            return Task.Factory.StartNew(() => Storage.DeleteFile(path));
        }
        ...
        {
            return Task.Factory.StartNew(() => Storage.DirectoryExists(dir));
        }
        ...
        {
            return Task.Factory.StartNew(() => Storage.GetDirectoryNames());
        }
        ...
        {
            return Task.Factory.StartNew(() => Storage.GetDirectoryNames(searchPattern));
        }
        ...
        {
            return Task.Factory.StartNew(() => Storage.GetFileNames());
        }
        ...
        {
            return Task.Factory.StartNew(() => Storage.GetFileNames(searchPattern));
        }
        ...
        {
            return Task.Factory.StartNew(() => (Stream)Storage.OpenFile(path, FileMode.Open, FileAccess.Read));
        }
        ...
        {
            return Storage.ReadAllTextAsync(path);
        }
        ...
        {
            return Storage.ReadAllTextAsync(path, encoding);
        }
        ...
        {
            return Storage.ReadAllLinesAsync(path);
        }
        ...
        {
            return Storage.ReadAllLinesAsync(path, encoding);
        }
        ...
        {
            return Storage.ReadAllBytesAsync(path);
        }
        ...
        {
            return Storage.WriteAllTextAsync(path, contents, encoding);
        }
        ...
        {
            return Storage.WriteAllLinesAsync(path, contents);
        }
        ...
        {
            return Storage.WriteAllLinesAsync(path, contents, encoding);
        }
        ...
        {
            return Storage.WriteAllBytesAsync(path, bytes);
        }
        ...
        {
            return Storage.AppendAllTextAsync(path, contents, encoding);
        }
        ...
        {
            return Storage.AppendAllLinesAsync(path, contents);
        }
        ...
        {
            return Storage.AppendAllLinesAsync(path, contents, encoding);
        }
    }
}